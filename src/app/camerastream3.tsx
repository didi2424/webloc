...
const CameraStream = () => {
  ...
  const stopWebSocket = useCallback(() => {
    ...
    // Additional cleanup: Ensure that any pending frame capturing tasks are canceled
    if (webcamRef.current) {
  ...
  useEffect(() => {
    ...
    return () => {
      // Cleanup function to stop capturing when component unmounts or isStreaming is set to false
      if (captureTimeout) {
        clearTimeout(captureTimeout);
      }
    };
